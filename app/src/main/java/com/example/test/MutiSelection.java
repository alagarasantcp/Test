...
public class MutiSelection extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_muti_selection);
        ...
        final String[] listItems = new String[]{"Chennai", "Coimbatore", "Pune"};
        ...
        bOpenAlertDialog.setOnClickListener(v -> {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(MutiSelection.this);
